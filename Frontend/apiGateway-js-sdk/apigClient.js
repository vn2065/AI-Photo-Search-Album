...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://x3atuhljz7.execute-api.us-east-1.amazonaws.com/first';
    ...
    apigClient.searchGet = function (params, body, additionalParams) {
        ...
        //apiGateway.core.utils.assertParametersDefined(params, ['q', 'Content-Type', 'Accept', 'x-amz-meta-customLabels'], ['body']);
